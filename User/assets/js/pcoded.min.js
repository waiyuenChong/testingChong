...
function togglemenu() {
    ...
    0 == $(".pcoded-navbar").hasClass("theme-horizontal") && (e <= 1200 && e >= 992 && $(".pcoded-navbar").addClass(""), e < 992 && $(".pcoded-navbar").removeClass("navbar-collapsed"))
}
...
$(document).ready(function () {
    ...
    if (togglemenu(), menuhrres(), $('[data-toggle="tooltip"]').tooltip(), $('[data-toggle="popover"]').popover(), $(".to-do-list input[type=checkbox]").on("click", function () {
        ...
        $(window)[0].innerWidth < 992 || $(".pcoded-navbar").hasClass("menupos-static") ? $(".navbar-content").slimScroll({
            setTop: "1px",
            size: "5px",
            wheelStep: 10,
            alwaysVisible: !1,
