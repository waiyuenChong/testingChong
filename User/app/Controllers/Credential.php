...
class Credential extends MY_Controller
{
    ...
    public function signup()
    {
        ...
        $position = $this->model->getWhere($array_position);

        $array_team = array(
            'table'   => 'Team',
            'select'  => 'id, name',
        );
        $team = $this->model->getWhere($array_team);
        ...
        if ($_POST) {
            ...
            $valid_name = $this->model->getWhere($name_array);
            ...
            $valid_email = $this->model->getWhere($email_array);

            $hp_array = array(
                'table'     => 'User',
                'select'    => 'phone_no',
                'condition' => ['phone_no' => $_POST['phone_no']]
            );
            $valid_handphone = $this->model->getWhere($hp_array);
    ...
    public function testing_template()
    {
        $this->header['css'] = array(
            // CSS_PATH . '/credential_common.css',
        );
        ...
        // echo view('templates/header', $this->header);
        echo view('templates/email/en/verify_email', $data);
        // echo view('templates/footer', $footer);
    }

    public function testing_template2()
    {
        $this->header['css'] = array(
            // CSS_PATH . '/credential_common.css',
        );
        ...
        // echo view('templates/header', $this->header);
        echo view('templates/email/en/verify_email2', $data);
        // echo view('templates/footer', $footer);
    }
}
