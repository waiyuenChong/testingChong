...
<div id="kt_header" style="" class="header align-items-stretch">
						...
						<div class="header-brand">
							...
							<a href="../dist/index.html">
								<img alt="Logo" src="<?= IMG_PATH; ?>/logo/default.svg" class="h-25px" />
							</a>
							<!--end::Logo-->
							<!--begin::Aside toggle-->
								...
								<div class="d-flex align-items-center pt-3 pt-sm-0">
									...
									<div class="d-flex">
										...
										<div class="d-flex flex-center">
											<!--begin::Menu wrapper-->
											<a href="#" class="btn btn-icon btn-primary fw-bolder" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom">3</a>
											<!--begin::Menu-->
												...
												<div class="tab-content">
													...
													<div class="tab-pane fade" id="kt_topbar_notifications_1" role="tabpanel">
														...
														<div class="py-3 text-center border-top">
															<a href="../dist/pages/user-profile/activity.html" class="btn btn-color-gray-600 btn-active-color-primary">View All
